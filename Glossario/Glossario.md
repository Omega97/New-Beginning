...
- **Difficoltà**: Il numero **minimo di ⚪** da estrarre per superare una **Prova** (di base **1**: Facile; poi Impegnativa 2, Ardua 3, Eccezionale 4+). Non confonderla con il **Rischio** (⚫ nel sacchetto) né con la **Soglia Critica**.
...
- **Narratore**: Il regista della storia, che stabilisce la **Difficoltà**, il **Rischio** e la **Soglia Critica**, applica **Status Tematici**, e interpreta gli esiti delle **Prove**, collaborando con i giocatori per tessere la narrazione.
...
- **Soglia Critica**: Numero **massimo di ⚫** che puoi estrarre **senza** subire un’**Uscita di Scena**. Se i ⚫ estratti sono **superiori** alla Soglia, l’eroe esce di scena. Più è alta, più sei al sicuro (non è un obiettivo da raggiungere).
