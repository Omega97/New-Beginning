...
4. **Spendi i TOKEN**:  
   - 1⚪ → superi la **PROVA** (pari alla Difficoltà).  
   - 1⚪ → **COLLOCHI** un ⚪ su *Furtivo*.
...
4. **Spendi i TOKEN**:  
   ...
   - 1⚫ → **COMPLICAZIONE**  
   - 1⚫ → **COMPLICAZIONE**  
   - Il ⚪ non basta a superare la prova: non lo spendi per il successo.
...
> Ricevi la sventura Orgoglio Ferito (1⚫ extra nel sacchetto alle prove sociali con nobili finché non ottieni la tua rivincita).
> Subisci una complicazione: ad assistere al duello c'era il nobile sul quale volevi fare una buona impressione...
> Subisci un’altra complicazione: la famiglia sta ripensando se affidarti il business di famiglia."*
...
> Ricevi la sventura Zoppo (2⚫ extra nel sacchetto alle prove di movimento finché non guarisci).”*
...
**SVENTURA**: **L'Ultima Goccia** ⚫⚫: Aggiungi 2⚫ extra nel sacchetto ogni volta che affronti una **PROVA** nel suddetto bar.
...
**SVENTURA**: **Orgoglio Ferito** ⚫: Aggiungi 1⚫ extra nel sacchetto ogni volta che affronti una **PROVA** relativa a una conoscenza in comune.
...
Se avessi estratto, ad esempio, ⚪⚪⚫: 1⚫ ≤ Soglia 1 → resti in scena; 2⚪ ≥ Difficoltà 1 e c’è un ⚫ → **SUCCESSO PARZIALE**. Spendi 1⚪ per superare; 1⚫ in complicazione o sventura (*Scarpe Fradice*).
